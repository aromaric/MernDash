#!/usr/bin/env node
var ut=Object.defineProperty;var B=(e=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(e,{get:(t,r)=>(typeof require!="undefined"?require:t)[r]}):e)(function(e){if(typeof require!="undefined")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});var ft=(e,t)=>{for(var r in t)ut(e,r,{get:t[r],enumerable:!0})};import{fileURLToPath as gt}from"url";import ht from"path";var xt=()=>gt(import.meta.url),wt=()=>ht.dirname(xt()),i=wt();import{Command as lo}from"commander";import uo from"figlet";import Ot from"react";import{render as _t}from"ink";import{readFileSync as Ct,existsSync as Et,readJSON as Pt,pathExists as fe}from"fs-extra";import It from"globby";import ge from"execa";import kt from"preferred-pm";import yt from"ora";var Tt=async(e,t)=>{let r=yt({color:"cyan",text:t}).start(),n=await e();return r.stop(),n},j=Tt;var L=()=>{if(!Et("package.json"))throw new Error("./package.json not found");return JSON.parse(Ct("package.json","utf8"))},M=()=>{let e=L();return Object.keys(e.dependencies||{})};var he=()=>{let e=L();return Object.keys(e.devDependencies||{})},K=()=>L().scripts,A=async()=>{var e;try{let t=await ge("npm",["ls","--depth=0","--json"],{reject:!1}),r=((e=JSON.parse(t.stdout))==null?void 0:e.dependencies)||{},n=Object.keys(r).filter(s=>s.startsWith("@pankod/refine")),o=[];for(let s of n){let m=r[s].version;o.push({name:s,version:m})}return o}catch{return Promise.resolve(null)}},xe=async()=>{try{let e=await It("node_modules/@pankod/refine-*",{onlyDirectories:!0}),t=[];return await Promise.all(e.map(async r=>{if(await fe(`${r}/package.json`)){let o=await Pt(`${r}/package.json`);t.push({name:o.name,path:r})}})),t}catch{return[]}},we=async e=>await fe(`${e}/refine.config.js`),W={npm:{install:["install","--save"],installDev:["install","--save-dev"],outdatedJson:["outdated","--json"]},yarn:{install:["add"],installDev:["add","-D"],outdatedJson:["outdated","--json"]},pnpm:{install:["add"],installDev:["add","-D"],outdatedJson:["outdated","--format","json"]}},_=async()=>{let e=await j(()=>kt(process.cwd()),"Getting package manager...");if(!e)throw new Error("Package manager not found.");return e},ye=async e=>{let t=await _();try{let r=W[t.name].install,n=ge(t.name,[...r,...e],{stdio:"inherit"});n.on("message",o=>{console.log(o)}),n.on("error",o=>{console.log(o)}),n.on("exit",o=>{if(o===0){console.log("All `refine` packages updated  \u{1F389}");return}console.log(`Application exited with code ${o}`)})}catch(r){throw new Error(r)}},Te=e=>{let t=e.lastIndexOf("@");return t<=0?{name:e,version:null}:{name:e.slice(0,t),version:e.slice(t+1)}};import E,{useRef as Ce}from"react";import St from"ink-table";import{Box as bt,Text as N}from"ink";var Ee={name:1,current:2,wanted:3,latest:4},Nt=4,te=e=>{let t=e.split(".");return{major:t[0],minor:t[1],patch:t[2]}},Pe=(e,t)=>e.major.trim()!==t.major.trim()?{major:"red",minor:"red",patch:"red"}:e.minor.trim()!==t.minor.trim()?{major:"white",minor:"yellow",patch:"yellow"}:e.patch.trim()!==t.patch.trim()?{major:"white",minor:"white",patch:"green"}:{major:"white",minor:"white",patch:"white"},vt=({data:e,command:t})=>{let r=Ce(1),n=Ce(0);return E.createElement(bt,{width:"100%",flexDirection:"column",alignItems:"center",justifyContent:"center"},E.createElement(N,null,"Update Available"),E.createElement(St,{data:e,cell:o=>{var h;let s=E.createElement(N,null,o.children),m=(h=o.children)==null?void 0:h.toString();if(!m)return s;let f=te(e[n.current].current);if(r.current===Ee.wanted){let c=te(m),l=Pe(f,c);s=E.createElement(Ie,{major:{color:l.major,text:c.major},minor:{color:l.minor,text:c.minor},patch:{color:l.patch,text:c.patch}})}if(r.current===Ee.latest){let c=te(m),l=Pe(f,c);s=E.createElement(Ie,{major:{color:l.major,text:c.major},minor:{color:l.minor,text:c.minor},patch:{color:l.patch,text:c.patch}})}return r.current===Nt?(n.current+=1,r.current=1):r.current+=1,s}}),E.createElement(N,null,"To update ",E.createElement(N,{bold:!0},"`refine`")," packages with the wanted version"),E.createElement(N,null,"Run the following command"," ",E.createElement(N,{color:"yellowBright"},t)))},Ie=({major:e,minor:t,patch:r})=>E.createElement(N,null,E.createElement(N,{color:e.color},e.text),E.createElement(N,{color:t.color},".",t.text,"."),E.createElement(N,{color:r.color},r.text)),ke=vt;var Dt=async()=>{let e="npx @pankod/refine-cli update",t=M(),r=Object.keys(K()),n=t.includes("@pankod/refine-cli"),o=r.includes("refine");if(!n&&!o)return e;let s=await _();return o?`${s.name} run refine update`:n?"npx refine update":e},G=async e=>{let t=await Dt();_t(Ot.createElement(ke,{data:e,command:t}))};import jt from"execa";import At from"semver-diff";var Rt=e=>e.command("check-updates").description("Check all installed `refine` packages are up to date").action($t),$t=async()=>{let e=await j(H,"Checking for updates...");if(!e.length){console.log("All `refine` packages are up to date \u{1F389}\n");return}await G(e)},H=async()=>await Ut(),Ut=async()=>{let e=await zt();if(!e)return[];let t=[];return Object.keys(e).forEach(n=>{let o=e[n];n.includes("@pankod/refine")&&t.push({name:n,current:o.current,wanted:o.wanted,latest:o.latest})}),t.filter(n=>!!At(n.current,n.latest))},zt=async()=>{let e="npm",{stdout:t,timedOut:r}=await jt(e,W[e].outdatedJson,{reject:!1,timeout:25e3});if(r)throw new Error("Timed out while checking for updates.");return t?JSON.parse(t):null},Se=Rt;import{copySync as Ht,unlinkSync as Jt,moveSync as qt,pathExistsSync as De,mkdirSync as Xt}from"fs-extra";import se from"temp";import{plural as Yt}from"pluralize";import Kt from"execa";import Gt from"inquirer";import{join as je}from"path";var J=(s=>(s.REACT_SCRIPT="react-scripts",s.REMIX="remix",s.NEXTJS="nextjs",s.VITE="vite",s.CRACO="craco",s))(J||{});var re=(o=>(o.ANTD="antd",o.MUI="mui",o.MANTINE="mantine",o.CHAKRA="chakra-ui",o))(re||{});var be=(n=>(n.NPM="npm",n.YARN="yarn",n.PNPM="pnpm",n))(be||{});var C=()=>{let e=M();if(e.includes("@craco/craco"))return"craco";if(e.includes("react-scripts"))return"react-scripts";if(e.includes("next"))return"nextjs";if(e.includes("@remix-run/react"))return"remix";if(he().includes("vite"))return"vite";throw new Error("Project type not found")},Ne=()=>{let e=M();if(e.includes("@pankod/refine-antd"))return"antd";if(e.includes("@pankod/refine-mui"))return"mui";if(e.includes("@pankod/refine-chakra-ui"))return"chakra-ui";if(e.includes("@pankod/refine-mantine"))return"mantine"};import R from"handlebars";import{readFileSync as Ft,readdirSync as Vt,createFileSync as Bt,writeFileSync as Lt,unlinkSync as Mt}from"fs-extra";var Wt=(e,t)=>{let r=Ft(e);return R.registerHelper("ifIn",function(o,s,m){return o.includes(s)?m.fn(R):m.inverse(R)}),R.registerHelper("formatInferencerComponent",function(o){if(!!o)switch(o){case"chakra-ui":return"ChakraUI";default:return o.charAt(0).toUpperCase()+o.slice(1)}}),R.registerHelper("capitalize",function(o){if(!!o)return o.charAt(0).toUpperCase()+o.slice(1)}),R.compile(r.toString())(t)},ve=(e,t)=>{Vt(e).forEach(n=>{let o=`${e}/${n}`,s=`${e}/${n.replace(".hbs","")}`;Bt(s),Lt(s,Wt(o,t)),Mt(o)})};var Oe=e=>e.charAt(0).toUpperCase()+e.slice(1);var oe=e=>{switch(e){case"nextjs":return{path:"src/components",alias:"../src/components"};case"remix":return{path:"app/components",alias:"~/components"}}return{path:"src/pages",alias:"pages"}},_e=e=>{switch(e){case"remix":return"./app";case"nextjs":case"react-scripts":case"vite":case"craco":default:return"./src"}};var ne=["list","create","edit","show"],Zt=e=>{let t=C(),{path:r}=oe(t);return e.command("create-resource").allowExcessArguments(!0).description("Create a new resource files").option("-a, --actions [actions]","Only generate the specified actions. (ex: list,create,edit,show)","list,create,edit,show").option("-p, --path [path]","Path to generate the resource files",r).action(Qt)},Qt=async(e,t)=>{let{args:r}=t,n=e.actions;if(!r.length){let{name:o,selectedActions:s}=await Gt.prompt([{type:"input",name:"name",message:"Resource Name",validate:m=>m?!0:"Resource Name is required"},{type:"checkbox",name:"selectedActions",message:"Select Actions",choices:ne,default:e.actions.split(",")}]);r=[o],n=s.join(",")}r.forEach(o=>{let s=n?n.split(","):void 0,{path:m,alias:f}=oe(C()),h=Yt(o).toLowerCase(),c=je(process.cwd(),m,h);if(De(c)){console.error(`Resource (${je(m,h)}) already exist! \u274C`);return}let l=Oe(o),I=Ne(),D=`${i}/../templates/resource`,b=er();Ht(D,b);let a={resourceName:o,resource:l,actions:s||ne,uiFramework:I};ve(b,a),s&&ne.forEach(k=>{s.includes(k)||Jt(`${b}/${k}.tsx`)}),Xt(e.path,{recursive:!0});let d=`${e.path}/${h}`,u={};De(d)&&(u={overwrite:!0}),qt(b,d,u),se.cleanupSync();let y=B.resolve(".bin/jscodeshift"),{stderr:x,stdout:w}=Kt.sync(y,["./","--extensions=ts,tsx,js,jsx","--parser=tsx",`--transform=${i}/../src/transformers/resource.ts`,"--ignore-pattern=**/.cache/**","--ignore-pattern=**/node_modules/**","--ignore-pattern=**/build/**","--ignore-pattern=**/.next/**",`--__actions=${a.actions}`,`--__pathAlias=${f}`,`--__resourceFolderName=${h}`,`--__resource=${l}`,`--__resourceName=${o}`]);x&&console.log(x),console.log(`Resource (${d}) generated successfully! \u{1F389}`)})},er=()=>(se.track(),se.mkdirSync("resource")),Ae=Zt;import tr from"envinfo";import rr from"ora";var or=e=>e.command("whoami").description("View the details of the development environment").action(nr),nr=async()=>{let e=rr("Loading environment details...").start(),t=await tr.run({System:["OS","CPU"],Binaries:["Node","Yarn","npm"],Browsers:["Chrome","Firefox","Safari"]},{showNotFound:!0,markdown:!0}),n=(await A()||[]).map(o=>` - ${o.name}: ${o.version}`).join(`
`);e.stop(),console.log(t),console.log("## Refine Packages:"),console.log(n)},Re=or;import{Option as cr}from"commander";import q from"inquirer";import Ue from"semver-diff";import ae from"chalk";var $e=e=>{let t=e.filter((n,o)=>e.indexOf(n)!==o),r=new Set(t);return Array.from(r)};var ze=async e=>{let t=ar(e);if(!t){console.log("All `refine` packages are up to date. \u{1F389}");return}let r=ir(t),n=await q.prompt([{type:"checkbox",name:"packages",message:"Choose packages to update",pageSize:r.pageSize,choices:r.choices,validate:sr}]);return n.packages.length>0?n.packages:null},sr=e=>{let r=e.map(o=>Te(o)).map(o=>o.name),n=$e(r);return n.length>0?`You can't update the same package more than once. Please choice one.
 Duplicates: ${n.join(", ")}`:!0},ar=e=>{if(e.length===0)return null;let t={patch:[],minor:[],major:[]};return e.forEach(r=>{let n=r.current,o=Ue(n,r.wanted),s=Ue(n,r.latest);if(o===s&&s){t[s].push({name:r.name,from:n,to:r.latest});return}o&&t[o].push({name:r.name,from:n,to:r.wanted}),s&&t[s].push({name:r.name,from:n,to:r.latest})}),t},ir=e=>{let t=0,r=0;[e.patch,e.minor,e.major].forEach(c=>{c.forEach(l=>{l.name.length>t&&(t=l.name.length),l.from.length>r&&(r=l.from.length)})}),t+=2;let n=[],o="Package".padEnd(t),s="From".padEnd(r),f=`
   ${o} ${s}${"To".padStart(r)}`;n.push(new q.Separator(f)),e.patch.length>0&&(n.push(new q.Separator(ae.reset.bold.blue(`
Patch Updates`))),e.patch.forEach(c=>{n.push({name:`${c.name.padEnd(t)} ${c.from.padStart(r)} -> ${c.to}`,value:`${c.name}@${c.to}`})})),e.minor.length>0&&(n.push(new q.Separator(ae.reset.bold.blue(`
Minor Updates`))),e.minor.forEach(c=>{n.push({name:`${c.name.padEnd(t)} ${c.from.padStart(r)} -> ${c.to}`,value:`${c.name}@${c.to}`})})),e.major.length>0&&(n.push(new q.Separator(ae.reset.bold.blue(`
Major Updates`))),e.major.forEach(c=>{n.push({name:`${c.name.padEnd(t)} ${c.from.padStart(r)} -> ${c.to}`,value:`${c.name}@${c.to}`})}));let h=n.length+6;return{choices:n,pageSize:h}};var pr=e=>e.command("update").description("Interactively select and update all `refine` packages to selected version. To skip the interactive mode, use the `--all` option.").addOption(new cr("-t, --tag [tag]","Select version to update to.").choices(["next","latest"]).default("wanted","Version ranges in the `package.json` will be installed")).option("-a, --all","Update all `refine` packages to the selected `tag`. If `tag` is not provided, version ranges in the `package.json` will be installed. This option skips the interactive mode.",!1).option("-d, --dry-run","Get outdated packages installation command without automatic updating. If `tag` is not provided, version ranges in the `package.json` will be used.",!1).action(mr),mr=async e=>{let{tag:t,dryRun:r,all:n}=e,o=await j(H,"Checking for updates...");if(!(o!=null&&o.length)){console.log("All `refine` packages are up to date \u{1F389}");return}let s=n?lr(t,o):await ze(o);if(!!s){if(r){dr(s);return}ur(s)}},lr=(e,t)=>e==="wanted"&&t.every(o=>o.current===o.wanted)?(console.log("All `refine` packages are up to date with the wanted version \u{1F389}"),null):t.map(n=>{let o=e==="wanted"?n.wanted:e;return`${n.name}@${o}`}),dr=async e=>{let t=await _(),r=W[t.name].install;console.log(`${t.name} ${r.join(" ")} ${e.join(" ")}`)},ur=e=>{console.log("Updating `refine` packages..."),console.log(e),ye(e)},Fe=pr;import Dr from"react";import{render as jr}from"ink";import Qe from"path";import U from"chalk";import Q from"inquirer";import Ar from"inquirer-autocomplete-prompt";import{ensureFile as Rr,pathExists as et,readFile as $r,writeFile as Ur}from"fs-extra";import Je from"path";import Tr from"path";var ie={};ft(ie,{PackageManagerTypes:()=>be,ProjectTypes:()=>J,UIFrameworks:()=>re,appendAfterImports:()=>Me,getFileContent:()=>Z,getImports:()=>$,getNameChangeInImport:()=>Be});var fr=/import(?:(?:(?:[ \n\t]+([^ *\n\t\{\},]+)[ \n\t]*(?:,|[ \n\t]+))?([ \n\t]*\{(?:[ \n\t]*[^ \n\t"'\{\}]+[ \n\t]*,?)+\})?[ \n\t]*)|[ \n\t]*\*[ \n\t]*as[ \n\t]+([^ \n\t\{\}]+)[ \n\t]+)from[ \n\t]*(?:['"])([^'"\n]+)(?:['"])(?:;?)/g,gr=/((?:\w|\s|_)*)( as )((?:\w|\s|_)*)( |,)?/g,$=e=>{let t=e.matchAll(fr),r=[];for(let n of t){let[o,s,m,f,h]=n;r.push({statement:o,importPath:h,...s&&{defaultImport:s},...m&&{namedImports:m},...f&&{namespaceImport:f}})}return r==null?void 0:r.filter(Boolean)},Be=e=>{let t=e.matchAll(gr),r=[];for(let n of t){let[o,s,m,f,h]=n;r.push({statement:o,fromName:s.trim(),toName:f.trim(),afterCharacter:h})}return r},hr=(e,t)=>{var s;let r=e.substring(0,e.indexOf(t.statement)),n=$(r).pop();return n?r.substring(r.indexOf(n==null?void 0:n.statement)+((s=n==null?void 0:n.statement)==null?void 0:s.length)):r},xr=(e,t)=>!!(t?hr(e,t):"").trim(),Ve=["react","@pankod/refine-core","@pankod/refine-"],Le=e=>{var b;let t=e,r=$(e),n=r.filter(a=>!a.statement.includes("import type ")),o=r.filter(a=>a.statement.includes("import type")),s=[],m=[];n.forEach(a=>{xr(e,a)?s.push(a):m.push(a)});let f=t.indexOf((b=m==null?void 0:m[0])==null?void 0:b.statement);m.forEach(a=>{t=t.replace(a.statement,"")}),o.forEach(a=>{t=t.replace(a.statement,"")});let h=m.reduce((a,d)=>{let{importPath:u}=d;return a[u]?a[u].push(d):a[u]=[d],a},{}),I=[...Object.entries(h).map(([a,d])=>{let u=d.find(k=>k.defaultImport),y=d.find(k=>k.namespaceImport),x=d.filter(k=>k.namedImports).map(k=>{var ee;return((ee=k.namedImports)!=null?ee:"").replace(/{|}/g,"").trim().split(",").map(Y=>Y.trim()).filter(Boolean).join(", ")}).join(", "),w="";return y&&(w+=y.statement+`
...
`),[a,w]})].sort(([a],[d])=>{let u=Ve.findIndex(x=>a.includes(x)),y=Ve.findIndex(x=>d.includes(x));return u===y?a.localeCompare(d):u===-1?1:y===-1?-1:u-y}).map(([,a])=>a).join(""),D=o.map(a=>a.statement).join(`
