...
`),[a,y]})].sort(([a],[d])=>{let u=st.findIndex(x=>a.includes(x)),C=st.findIndex(x=>d.includes(x));return u===C?a.localeCompare(d):u===-1?1:C===-1?-1:u-C}).map(([,a])=>a).join(""),z=o.map(a=>a.statement).join(`
`);return t=t.substring(0,f)+k+z+t.substring(f),t};var ct=(e,t)=>{let r=L(e),n=r[r.length-1],o=n?e.indexOf(n.statement):e.length-1;return e.slice(0,o+(n==null?void 0:n.statement.length))+`
`+t+`
`+e.slice(o+(n==null?void 0:n.statement.length))};var pt=require("fs-extra"),mt=require("path");function ne(e){if(!!(this!=null&&this.absolutePackageDir))try{return(0,pt.readFileSync)((0,mt.join)(this.absolutePackageDir,e)).toString()}catch{return}}var dt=require("module"),br=dt.prototype.require,ut=(e,t)=>{dt.prototype.require=function(...r){return r[0]==="@pankod/refine-cli"?{...ge,getFileContent:n=>ne.call({absolutePackageDir:t?e:lt.default.join(process.cwd(),e)},n)}:br.apply(this,r)}};var ft=async(e,t)=>{try{return ut(e,t),require(he.default.join(t?e:he.default.join(process.cwd(),e),"refine.config.js"))}catch{return}};var se=require("prettier"),gt=async e=>{try{let t=await(0,se.resolveConfig)(process.cwd());return(0,se.format)(e,{...t!=null?t:{},parser:"typescript"})}catch{return e}};var g=p(require("react")),Tt=p(require("ink-markdown")),Ct=p(require("dedent")),w=require("ink");var I={SUCCESS:"SUCCESS",UNKNOWN_ERROR:"UNKNOWN_ERROR",SOURCE_PATH_NOT_FOUND:"SOURCE_PATH_NOT_FOUND",TARGET_PATH_NOT_FOUND:"TARGET_PATH_NOT_FOUND",SOURCE_PATH_NOT_A_FILE:"SOURCE_PATH_NOT_A_FILE",TARGET_ALREADY_EXISTS:"TARGET_ALREADY_EXISTS"};var ht=p(require("chalk")),xt=p(require("cardinal")),wt=p(require("boxen")),Nr=e=>{var o;let t=/^(?:\/\/\s?title:\s?)(.*?)\n/g,[r,n]=(o=t.exec(e))!=null?o:[];if(n){let s=n.trim(),m=e.replace(r,"");return{title:s,code:m}}return{code:e}},yt=e=>{let{title:t,code:r}=Nr(e),n="";try{n=xt.default.highlight(r,{jsx:!0})}catch{n=r}return(0,wt.default)(n,{padding:1,margin:0,borderStyle:"round",borderColor:"gray",titleAlignment:"left",title:t?ht.default.bold(t):void 0})};var vr=({label:e,files:t,message:r="**`Warning:`** You should use the component where you want to use it."})=>{let n=t.filter(([,i])=>Object.values(I).filter(l=>l!==I.SUCCESS).includes(i)),o="success";switch(n.length){case 0:o="success";break;case t.length:o="error";break;default:o="warning";break}let s=()=>{switch(o){case"success":return g.default.createElement(w.Text,{color:"blueBright"},"Successfully swizzled ",g.default.createElement(w.Text,{bold:!0},e));case"warning":return g.default.createElement(w.Text,{color:"yellowBright"},"Swizzle completed with errors for"," ",g.default.createElement(w.Text,{bold:!0},e));case"error":return g.default.createElement(w.Text,{color:"redBright"},"Swizzle failed for ",g.default.createElement(w.Text,{bold:!0},e))}return null},m=i=>{let l=i==null?void 0:i.replace(process.cwd(),"");return l!=null&&l.startsWith("/")?l.slice(1):l!=null&&l.startsWith("./")?l.slice(2):l},f=()=>g.default.createElement(g.default.Fragment,null,g.default.createElement(w.Text,{dimColor:!0},"File",t.length>1?"s":""," created:"),t.map(([i,l],k)=>l===I.SUCCESS?g.default.createElement(w.Text,{key:k,dimColor:!0,color:"cyanBright"},` - ${m(i)}`):l===I.TARGET_ALREADY_EXISTS?g.default.createElement(w.Text,{key:k,dimColor:!0,color:"cyanBright"}," - ",g.default.createElement(w.Text,{color:"yellowBright",bold:!0},"[FILE_ALREADY_EXISTS]"," "),`${m(i)}`):l===I.SOURCE_PATH_NOT_A_FILE?g.default.createElement(w.Text,{key:k,dimColor:!0,color:"cyanBright"}," - ",g.default.createElement(w.Text,{color:"yellowBright",bold:!0},"[SOURCE NOT FOUND]"," "),`${m(i)}`):g.default.createElement(w.Text,{key:k,dimColor:!0,color:"cyanBright"}," - ",g.default.createElement(w.Text,{color:"yellowBright",bold:!0},"[",l,"]")))),h=()=>r&&o!=="error"?g.default.createElement(g.default.Fragment,null,g.default.createElement(Tt.default,{code:yt},(0,Ct.default)(`
`+r)),g.default.createElement(w.Text,null,"\xA0")):null;return g.default.createElement(w.Box,{width:"100%",flexDirection:"column",alignItems:"flex-start",justifyContent:"flex-start"},g.default.createElement(w.Text,null,"\xA0"),s(),f(),g.default.createElement(w.Text,null,"\xA0"),h())},Et=vr;var Pt=e=>{let t=/(\/\/|\/\*)(\s?)swizzle-remove-start([\s\S]*?)(\/\/|\/\*)(\s?)swizzle-remove-end(\s*)(\*\/)?/g;return e.replace(t,"")};var vt=p(require("boxen"));var It=()=>{let e;try{e=E()}catch{e=void 0}return qe(e)};var Or=e=>e.command("swizzle").description(`Export a component or a function from ${U.default.bold("refine")} packages to customize it in your project`).action(_r),kt=e=>(t,r="")=>e.filter(o=>{var s;return o.label.toLowerCase().includes(r.toLowerCase())||((s=o.group)==null?void 0:s.toLowerCase().includes(r.toLowerCase()))}).flatMap((o,s,m)=>{var i;return[...(o==null?void 0:o.group)&&((i=m[s-1])==null?void 0:i.group)!==o.group&&o.group?[new G.default.Separator(`${U.default.bold(o.group)}`)]:[],{name:` ${o.label}`,value:o!=null&&o.value?o.value:o}]}),_r=async e=>{var l,k,z,v;G.default.registerPrompt("autocomplete",Nt.default);let t=await ve(),r=[];if(await Promise.all(t.map(async a=>{await Oe(a.path)&&r.push(a)})),r.length===0){console.log("No refine packages found with swizzle configuration.");return}console.log(`${(0,vt.default)(`Found ${U.default.blueBright(r.length)} installed ${U.default.blueBright.bold("refine")} packages with swizzle configuration.`,{padding:1,textAlignment:"center",dimBorder:!0,borderColor:"blueBright",borderStyle:"round"})}
`);let n=await Promise.all(r.map(async a=>{var u;let d=(u=await ft(a.path))!=null?u:{swizzle:{items:[]}};return{...a,config:d}})),{selectedPackage:o}=await G.default.prompt([{type:"autocomplete",pageSize:10,name:"selectedPackage",message:"Which package do you want to swizzle?",emptyText:"No packages found.",source:kt(n.sort((a,d)=>{var u,C,x,y;return((C=(u=a.config)==null?void 0:u.group)!=null?C:"").localeCompare((y=(x=d.config)==null?void 0:x.group)!=null?y:"")}).map(a=>{var d,u,C;return{label:(u=(d=a.config)==null?void 0:d.name)!=null?u:a.name,value:a,group:(C=a.config)==null?void 0:C.group}}))}]),{swizzle:{items:s,transform:m}}=o.config,f;if(s.length===0){console.log(`No swizzle items found for ${U.default.bold((k=(l=o.config)==null?void 0:l.name)!=null?k:o.name)}`);return}else s.length===1?f=s[0]:s.length>1&&(f=(await G.default.prompt([{type:"list",pageSize:10,name:"selectedComponent",message:"Which component do you want to swizzle?",emptyText:"No components found.",choices:kt(s.sort((d,u)=>d.group.localeCompare(u.group)))({},"")}])).selectedComponent);if(!f){console.log(`No swizzle items selected for ${U.default.bold((v=(z=o.config)==null?void 0:z.name)!=null?v:o.name)}`);return}let h=It(),i=await Promise.all(f.files.map(async a=>{var d,u,C;try{let x=a.src?xe.default.join(o.path,a.src):void 0,y=a.dest?xe.default.join(process.cwd(),h,a.dest):void 0;if(!x)return console.log("No src path found for file",a),["",I.SOURCE_PATH_NOT_FOUND];if(!y)return console.log("No destination path found for file",a),["",I.TARGET_PATH_NOT_FOUND];if(!await(0,D.pathExists)(x))return[y,I.SOURCE_PATH_NOT_A_FILE];let Pe=await(0,D.readFile)(x,"utf-8");if(await(0,D.pathExists)(y))return[y,I.TARGET_ALREADY_EXISTS];await(0,D.ensureFile)(y);let Q=Pt(Pe),Ie=(u=(d=a.transform)==null?void 0:d.call(a,Q))!=null?u:Q,Ht=(C=m==null?void 0:m(Ie,x,y))!=null?C:Ie,Jt=it(Ht),qt=await gt(Jt);return await(0,D.writeFile)(y,qt),[y,I.SUCCESS]}catch{return["",I.UNKNOWN_ERROR]}}));i.length>0&&(0,bt.render)(St.default.createElement(Et,{label:f.label,files:i,message:f.message}))},Ot=Or;var Z=`${process.cwd()}/node_modules/.bin`,N={["react-scripts"]:{dev:["start"],start:["start"],build:["build"],getBin:()=>`${Z}/react-scripts`},["vite"]:{dev:["start"],start:["preview"],build:["build"],getBin:()=>`${Z}/vite`},["nextjs"]:{dev:["dev"],start:["start"],build:["build"],getBin:()=>`${Z}/next`},["remix"]:{dev:["dev"],start:["build"],build:["build"],getBin:e=>`${Z}/${e==="start"?"remix-serve":"remix"}`},["craco"]:{dev:["start"],start:["start"],build:["build"],getBin:()=>`${Z}/craco`}};var _t=p(require("execa")),j=async(e,t)=>{var n,o;let r=(0,_t.default)(e,t,{stdio:"pipe",windowsHide:!1,env:{FORCE_COLOR:"true",...process.env}});return(n=r.stdout)==null||n.pipe(process.stdout),(o=r.stderr)==null||o.pipe(process.stderr),await r};var Rt=p(require("conf")),$t=p(require("chalk"));var Dt=p(require("dotenv"));Dt.config();var Dr={development:/dev/i,production:/prod/i,test:/test|tst/i,"continuous-integration":/ci/i,"user-acceptance-testing":/uat/i,"system-integration-testing":/sit/i},jr=()=>{let e=process.env.NODE_ENV;if(!e)return"development";let t="custom";for(let[r,n]of Object.entries(Dr))if(n.test(e)){t=r;break}return t},M={NODE_ENV:jr(),REFINE_NO_TELEMETRY:process.env.REFINE_NO_TELEMETRY||"false",UPDATE_NOTIFIER_IS_DISABLED:process.env.UPDATE_NOTIFIER_IS_DISABLED||"false",UPDATE_NOTIFIER_CACHE_TTL:process.env.UPDATE_NOTIFIER_CACHE_TTL||1e3*60*60*24};var jt=e=>typeof btoa<"u"?btoa(e):Buffer.from(e).toString("base64");var Ar="refine-update-notifier",A=new Rt.default({projectName:Ar,defaults:{key:"",lastUpdated:0,packages:[]}}),W=async()=>{if(Fr())return;let e=await $r();if(e!==null){if(e){At();return}Rr(),At()}},Rr=async()=>{let e=A.get("packages");!(e!=null&&e.length)||(await te(e),console.log(`
`))},$r=async()=>{let e=await zr(),t=Ur();return e===null?null:!!(t||!e)},At=async()=>{try{let e=await Y();return A.set("packages",e),A.set("lastUpdated",Date.now()),A.set("key",await Ut()),e}catch{return A.set("packages",[]),A.set("lastUpdated",Date.now()),A.set("key",""),null}},Ur=()=>{let e=A.get("lastUpdated");if(!e)return!0;let r=Date.now()-e,n=Number(M.UPDATE_NOTIFIER_CACHE_TTL);return r>=n},zr=async()=>{let e=A.get("key"),t=await Ut();return t===null?null:e===t},Ut=async()=>{let e=await V();if(!e)return console.error($t.default.red("Something went wrong when trying to get installed `refine` packages.")),null;let t=e.map(n=>`${n.name}@${n.version}`);return jt(t.toString())},Fr=()=>M.UPDATE_NOTIFIER_IS_DISABLED.toLocaleLowerCase()==="true";var H=e=>{let t=E(),r=N[t][e];return t==="remix"&&e==="start"&&(t="remix-serve"),`It runs: \`${t} ${r.join(" ")}\`. Also accepts all the arguments \`${t}\` accepts.`};var Vr=e=>e.command("start").description(H("start")).allowUnknownOption(!0).argument("[args...]").action(Br),Br=async e=>{let t=E(),r=N[t].getBin("start"),o=[...N[t].start,...e];await W(),j(r,o)},we=Vr;var Lr=e=>e.command("dev").description(H("dev")).allowUnknownOption(!0).argument("[args...]").action(Mr),Mr=async e=>{let t=E(),r=N[t].getBin("dev"),o=[...N[t].dev,...e];await W(),j(r,o)},ye=Lr;var Wr=e=>e.command("build").description(H("build")).allowUnknownOption(!0).argument("[args...]").action(Hr),Hr=async e=>{let t=E(),r=N[t].getBin("build"),o=[...N[t].build,...e];await W();try{await j(r,o)}catch{process.exit(1)}},Te=Wr;var Ce=p(require("chalk"));var Jr=e=>e.command("run").description("Runs a defined package script. If no `command` is provided, it will list the available scripts").allowUnknownOption(!0).argument("[command] [args...]").action(qr),qr=async e=>{let[t,...r]=e,n=ee();if(!t){console.log(`Available via ${Ce.default.blue("`refine run`")}:
