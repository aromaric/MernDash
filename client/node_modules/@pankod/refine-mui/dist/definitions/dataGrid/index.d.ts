...
export declare const transformMuiOperatorToCrudOperator: (operatorValue?: string) => Exclude<CrudOperators, "or">;
export declare const transformFilterModelToCrudFilters: ({ items, linkOperator, }: GridFilterModel) => CrudFilters;
