...
import { ProfileProps, IncidentProps } from "interfaces/common";
...
const Profil = ({ type, name, avatar, email, incidents }: ProfileProps) => (
    <Box>
        ...
        {incidents.length > 0 && (
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
                ...
                >
                    {incidents?.map((incident: IncidentProps) => (
                        <IncidentCard
                            key={incident._id}
                            id={incident._id}
